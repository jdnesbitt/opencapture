...
/**
 * This class is used to convert, insert, or delete pages from a GIF 
 * image.
 */
public class ToGIF implements IConversion 
{
	private static final String SUPPORTED_DOCUMENT_FORMAT = "GIF";
    ...
    public void savePage(OutputStream os, int pageNumber) throws Exception
    {
       ...
       try
       {
    	   ...
    	   {
    		   throw new Exception("Problem writting GIF!");
    	   }
       }
       catch(Exception e)
       {
...
//    		ih = img.getHeight(null);
    		...
    		if(resize)
    		{
    			...
    			this.documentProperties.put("RESIZEDIMAGEWIDTH", String.valueOf(image.getWidth()));
    			this.documentProperties.put("RESIZEDIMAGEHEIGHT", String.valueOf(image.getHeight()));
    		}
...
//			ToPDF tp = new ToPDF();
//			
//			tp.setDocument("C:\\temp\\GIF1.gif.pdf");
//			
//			// get image list
//			tg.setDocument(tp.getBufferedImages());
//			
//			tg.saveDocument("C:\\temp\\GIF.gif");
			
			//GifImage gi = new GifImage("c:\\temp\\1010694-0.gif");
			
			FileInputStream is = new FileInputStream("c:\\temp\\1010694-0.gif");
			...
			if(!ii.check())
			{
				System.out.println("No a supported image formt.");
				return;
			...
			System.out.println(ii.getFormatName() + ", " + ii.getMimeType() +
					    ...
					    " image(s), " + ii.getPhysicalWidthDpi()+ " vertical resolution, " + ii.getPhysicalWidthDpi() +
					    " horizontal resolution, " + ii.getNumberOfComments() + " comment(s).");
			
//			java.awt.Image im = Toolkit.getDefaultToolkit().getImage("c:\\temp\\1010694-0.gif");
