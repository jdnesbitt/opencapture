...
public class ToZIP implements IConversion 
{
	private static final String SUPPORTED_DOCUMENT_FORMAT = "ALL";
     ...
     * Default constructor
     */
    public ToZIP() throws Exception
    {
        throw new Exception("ToZIP not yet implemented!");
