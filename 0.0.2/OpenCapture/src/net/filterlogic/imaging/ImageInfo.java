 ...
 * PNG, IFF, RAS, PBM, PGM, PPM, PSD and SWF files (or input streams). <p/> Use
 * the class like this:
 * 
 * <pre>
 ...
 * <p/> Written by <a
 * href="http://www.geocities.com/marcoschmidt.geo/contact.html">Marco Schmidt</a>.
 * <p/> This class is contributed to the Public Domain. Use it at your own risk.
 * <p/> Last modification 2004-02-29. <p/> History:
 * <ul>
...
public class ImageInfo {
	 ...
	 */
	public static final String[] MIME_TYPE_STRINGS = { "image/jpeg",
