...
public class MappingFile
{
    ...
    private static String TRIGGER_XSLT_XPATH = "/MappingFile/Trigger/@XSLT";
    ...
    private static String VALUE_MAPPING_KEY_VALUE_XPATH = "@KeyValue";
    ...
    private void setTriggerInfo()
    {
        ...
        xslt = xmlParser.getValue(TRIGGER_XSLT_XPATH,"");
        ...
        for(int i=0;i<list.size();i++)
        {
            ...
            try
            {
                ...
                for(int v=0;v<valueMaps.size();v++)
                {
                    ...
                    String keyValue = xmlParser.getValue(VALUE_MAPPING_KEY_VALUE_XPATH, vmNode);

                    ValueMap valueMap = new ValueMap(id, type, value, keyValue);
