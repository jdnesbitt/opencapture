 ...
 */
public class Code128Reader implements IZoneReader 
{

    private BufferedImage m_Image = null;
    private BufferedImage m_Snapshot = null;
    private Zone m_Zone = null;
    private static final String m_READER_NAME = "Code128Reader";
    ...
    private String ReadZone(int x, int y, int height, int width, BufferedImage image) throws OpenCaptureReaderException
    {
        ...
        try
        {
            ...
            String result = new com.google.zxing.oned.Code128Reader().decode(bitmap, hints).getText();
